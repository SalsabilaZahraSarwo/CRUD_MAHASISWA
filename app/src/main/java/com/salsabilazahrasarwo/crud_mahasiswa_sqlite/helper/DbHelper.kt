package com.salsabilazahrasarwo.crud_mahasiswa_sqlite.helper
...
class DbHelper (context: Context):
    ...
    fun getAllDataMahasiswa(): List<ModelMahasiswa> {
        ...
        while (cursor.moveToNext()) {
            ...
            Log.d("Databasehelper", "Fecthed ID : $id, namamahasiswa: $nama_mahasiswa")
    ...
    companion object{
        ...
        private lateinit var Instances: DbHelper
    }
}